...
class Test03_mathematics_numbers_series_sum(unittest.TestCase):
    def test_list_int(self):
        ...
        *** Test03 **** GIVEN: import mathematics.numbers.series as series *** FUNCTION CALL: series.sum(list = [1, 2, 3, 4, 5]) *** EXPECT: 15 ***
        ...
        self.assertEqual(15, series.sum(my_list = [1, 2, 3, 4, 5]))
        print()
...
class Test04_mathematics_numbers_series_average(unittest.TestCase):
    def test_list_int(self):
        ...
        *** Test04 **** GIVEN: import mathematics.numbers.series as series *** FUNCTION CALL: series.average(list = [1, 2, 3, 4, 5]) *** EXPECT: 3.0 ***
        """
        import mathematics.numbers.series as series
        self.assertEqual(3.0, series.average(my_list = [1, 2, 3, 4, 5]))
        print()
...
class Test17_mathematics_numbers_algebra_quadratic(unittest.TestCase):
    def test_list_int(self):
        """
        *** Test17 **** GIVEN: import mathematics.numbers.algebra as algebra *** FUNCTION CALL: algebra.quadratic(a=1, b=-3, c=2) *** EXPECT: (2.0, 1.0) ***
        """
        import mathematics.numbers.algebra as algebra
        self.assertEqual((2.0, 1.0), algebra.quadratic(a=1, b=-3, c=2))
        print()

class Test18_mathematics_geometry_circle_sphere(unittest.TestCase):
    def test_list_int(self):
        """
        *** Test18 **** GIVEN: import mathematics.geometry.circle as circle *** FUNCTION CALL: circle.sphere(radius=3) *** EXPECT: 113.09733552923254 ***
        """
        import mathematics.geometry.circle as circle
        self.assertAlmostEqual(113.09733552923254, circle.sphere(radius=3))
        print()
